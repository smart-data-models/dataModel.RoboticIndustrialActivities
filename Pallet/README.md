...
[链接到规范](https://github.com/smart-data-models/dataModel.RoboticIndustrialActivities/blob/master/Pallet/doc/spec_ZH.md)

[사양 링크](https://github.com/smart-data-models/dataModel.RoboticIndustrialActivities/blob/master/Pallet/doc/spec_KO.md)
### Examples
...
Link to the [PostgreSQL schema](https://github.com/smart-data-models/dataModel.RoboticIndustrialActivities/blob/master/Pallet/schema.sql) of this data model
### Contribution
