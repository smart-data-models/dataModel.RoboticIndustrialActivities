...
manufacturabilityOnFlexEdge = "{'type': 'Property', 'value': 'CanProcess'}"
attribute = "manufacturabilityOnFlexEdge"
value = manufacturabilityOnFlexEdge
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

palletId = "{'type': 'Property', 'value': '0001'}"
attribute = "palletId"
value = palletId
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

priority = {'type': 'Property', 'value': 3}
attribute = "priority"
value = priority
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

refGoingTo = "{'type': 'Relationship', 'object': 'urn:ngsi-ld:RoboticCell:FlexEdge'}"
attribute = "refGoingTo"
value = refGoingTo
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))
